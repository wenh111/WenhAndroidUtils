...
public class LogUtil {
    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && Logger.getContext().getExternalCacheDir() != null)
                defaultDir = Logger.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = Logger.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
    ...
    public static String i(final String tag, final Object... contents) {
        return log(I, tag, contents);
    }
    ...
    public static String w(final String tag, final Object... contents) {
        return log(W, tag, contents);
    }
    ...
    public static String e(final String tag, final Object... contents) {
        return log(E, tag, contents);
    }
    ...
    public static String json(final String tag, final String contents) {
        return log(JSON | D, tag, contents);
    }
    ...
    private static String log(final int type, final String tag, final Object... contents) {
        if (!sLogSwitch || (!sLog2ConsoleSwitch && !sLog2FileSwitch)) return null;
        int type_low = type & 0x0f, type_high = type & 0xf0;
        if (type_low < sConsoleFilter && type_low < sFileFilter) return null;
    ...
    private static String[] processTagAndHead(String tag) {
        if (!sTagIsSpace && !sLogHeadSwitch) {
            ...
            StackTraceElement targetElement = new Throwable().getStackTrace()[4];
